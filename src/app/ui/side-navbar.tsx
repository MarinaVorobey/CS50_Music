export default function SideNavbar() {
  return (
    <aside className="aside">
      <h2 className="aside__h2 visually-hidden">Левая панель навигации</h2>
      <nav className="aside__nav">
        ...
        <ul className="aside__list">
          ...
          <li className="aside__item">
            <button className="aside__btn">Любимые песни</button>
          </li>
          <li className="aside__item">
            <button className="aside__btn">Плейлист #1</button>
          </li>
          <li className="aside__item">
            <button className="aside__btn">Плейлист #2</button>
          </li>
          <li className="aside__item">
            <button className="aside__btn">Плейлист #3</button>
          </li>
          <li className="aside__item">
            <button className="aside__btn">Плейлист #4</button>
          </li>
          <li className="aside__item">
            <button className="aside__btn">Плейлист #5</button>
          </li>
          <li className="aside__item">
            <button className="aside__btn">Плейлист #6</button>
          </li>
          <li className="aside__item">
            <button className="aside__btn">Плейлист #7</button>
          </li>
        </ul>
      </nav>
    </aside>
